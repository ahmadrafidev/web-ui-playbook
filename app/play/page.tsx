    ...
    },
    {
      ...
      preview: (
        <div className="border rounded overflow-hidden text-xs">
          <div className="bg-gray-50 px-2 py-1 border-b font-medium">Header</div>
          <div className="px-2 py-1">Data row</div>
        </div>
      ),
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Component Playground</h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Interactive preview of all UI components. Explore, test, and see how each component works.
          </p>
        </div>
      </section>
